...
echo -n "$(cat scripts/seeds/core-test-$c | sed '2!d')" >> allnodes.txt
echo -n "," >> allnodes.txt
seed=$(cat scripts/seeds/core-test-$c | sed '1!d')
...
echo -n "$(cat scripts/seeds/core-test-$1 | sed '2!d')" >> allnodes.txt

seed=$(cat scripts/seeds/core-test-$1 | sed '1!d')
